...
::: {.callout-tip collapse="true" icon="false" style="width:100%; background-color: var(--bg-transparent)!important; border-color: var(--collapsed-border-color)!important;" title="[{{< iconify pixelarticons expand >}} `output`:]{.code-text}"}
