...
setuptools.setup(
    ...
    url='https://github.com/saforem2/l2hmc-qcd',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Sam Foreman',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='saforem2@gmail.com',  # Optional
    ...
    # larger catalog.
    keywords='mcmc, lattice, lgt, ml',  # Optional
