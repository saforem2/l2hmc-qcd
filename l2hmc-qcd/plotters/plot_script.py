...
from plot_observables import get_run_dirs, get_title_str
from lattice.lattice import u1_plaq_exact
from plot_utils import bootstrap, load_pkl
...
def plotter(log_dirs):
    ...
    for idx, log_dir in enumerate(log_dirs):
        ...
        for run_dir in run_dirs:
            ...
            g = g.map_upper(plt.plot, color=colors[idx],
            ...
            try:
                ...
                g = g.map_lower(plt.hist, histtype='step',
